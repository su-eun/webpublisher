!function () {
    ...
    t.prototype.buildSections = function () { 
        for (var t = this.defaults.sections, e = 0; e < t.length; e++)t[e].setAttribute("data-index", e); return this }, 
    t.prototype.buildDots = function () {
        this.ul = document.createElement("ul"), 
        this.ul.classList.add("dots"), 
        this.ul.classList.add("right" == this.defaults.dotsPosition ? "dots-right" : "dots-left");
        for (var t = this, e = this.defaults.sections, n = 0; n < e.length; n++) { 
            ...
            return this.ul.childNodes[0].firstChild.classList.add("active"),
            this.defaults.displayDots && document.body.appendChild(this.ul), this 
